...
if TYPE_CHECKING:
    from campa.tl import TorchExperiment #, Experiment
    import numpy as np
...
from campa.tl import LossEnumTorch, ModelEnumTorch #, LossEnum, ModelEnum
from campa.data import NNTorchDataset# , NNDataset
from campa.tl._layers import UpdateSparsityLevelTorch #, UpdateSparsityLevel
